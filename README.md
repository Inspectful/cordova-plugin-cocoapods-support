...
<plugin id="cordova-plugin-withpods" version="1.0.0" xmlns="http://apache.org/cordova/ns/plugins/1.0">
    ...
    <platform name="ios">
        <!-- optionally set minimum ios version and enable use_frameworks! and enable legacy swift (2.3)-->
        <pods-config ios-min-version="9.0" uses-frameworks="true" use-legacy="true"/>
        <pod id="LatestPod" />
